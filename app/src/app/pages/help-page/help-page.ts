...
export class HelpPage {
  faqs = [
    {
      ...
      answer: 'Sí, aunque puedes agregar los productos que quieras al carrito de compras sin estar registrado. Cuando realices el proceso de compra debes ingresar tus datos personales, así como el método de envío y tu medio de pago.',
    ...
    },
    {
      ...
      answer: 'Selecciona el producto, agrégalo al carrito y sigue el flujo de pago donde podrás escoger envío y forma de pago.',
    ...
    },
    {
      ...
      answer: 'Los precios en línea pueden variar respecto a la tienda física. Revisa las condiciones en cada producto.',
  ...
  answerHtml: `Sí, el catalogo es el mismo. Sin embargo, para recibir información sobre la disponibilidad de productos en nuestras tiendas puedes comunicarte a nuestra línea de servicio al cliente <span class="phone">(601) 4073033</span>.`,
    ...
    },
    {
      ...
      answer: 'Consulta la política de devoluciones; normalmente es posible dentro de los plazos establecidos y con la documentación requerida.',
    ...
    ,
    {
      ...
      answer: 'Algunas promociones o productos pueden tener límites de compra; revisa las condiciones en la página del producto.',
      answerHtml: 'Sí, la restricción se calcula por un número máximo de artículos y el valor total del pedido. En el momento de agregar los productos al carrito te informaremos si superas ese límite.',
      open: false
    },
    {
      question: '¿Puedo hacer compras desde fuera de Colombia?',
      answer: 'La plataforma está orientada principalmente a clientes en Colombia; verifica si tu país es soportado o si el envío internacional está disponible.',
      answerHtml: 'Si, siempre y cuando el pago se realice con medios de pago emitidos en Colombia y se pueda validar el pago.',
      open: false
    },
    {
      question: '¿Puedo comprar más de una unidad del mismo artículo?',
      answer: 'Sí, por lo general puedes seleccionar la cantidad deseada, salvo restricciones puntuales por stock o promociones.',
    ...
    },
    {
      ...
      answer: 'Consulta las opciones de envío internacional y las políticas de importación; en algunos casos es posible con proveedores de logística.',
      answerHtml: 'Aquí puedes consultar el listado completo de las ciudades y municipios en los que tenemos cobertura.',
      open: false
    },
    {
      question: '¿Con qué medios puedo pagar?',
      answer: 'Aceptamos tarjetas de crédito/débito, PSE y otros medios que se muestran en el checkout. Revisa las opciones disponibles al pagar.',
    ...
    },
    {
      ...
      answer: 'Algunas combinaciones pueden no estar permitidas; verifica en el checkout si está disponible la opción de dividir el pago.',
    ...
    },
    {
      ...
      answer: 'Sí, puedes contactar al servicio de atención al cliente para recibir ayuda durante el proceso de compra.',
  answerHtml: 'Sí, si necesitas ayuda puedes comunicarte a nuestra línea de venta telefónica <span class="phone">(601) 746 8001</span>.',
      open: false
    },
    {
      question: '¿El pago es seguro?',
      answer: 'Sí, utilizamos protocolos de seguridad y proveedores de pago certificados para proteger tus datos.',
      answerHtml: 'Tomamos todas las medidas de seguridad que se encuentran a nuestro alcance para garantizar la seguridad de tus compras.',
      open: false
    },
    {
      question: '¿Si un producto presenta una falla lo puedo cambiar?',
      answer: 'Depende de la garantía y la política de devoluciones; revisa la sección de garantías y la política de cambios.',
      answerHtml: 'Sí, para conocer las condiciones e instrucciones para realizar un cambio te invitamos a consultar nuestra Política de Cambios y Devoluciones.',
      open: false
    },
    {
      question: '¿A dónde me puedo comunicar si tengo una duda?',
      answer: 'Puedes comunicarte al servicio de atención al cliente o usar los canales de contacto disponibles en la página.',
